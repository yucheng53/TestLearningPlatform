...
<body>
	<div class="container-sm">
		<div class="header">
			<h1>Welcome to the student board!</h1>
		</div>
		<div class="">
			<div>
				<form:form action="/student_save" method="POST" modelAttribute="student">
					...
					<form:label class="col-sm-3 col-form-label" path="subject">What subject would you like to study? </form:label>
					<form:errors path="subject" class="text-danger"></form:errors>
					<form:input type="text" class="form-control" path="subject"></form:input>
					
					<form:label class="col-sm-3 col-form-label" path="education">What's your highest education? </form:label>
					...
					<form:label class="col-sm-3 col-form-label" path="major">What do you major in? </form:label>
